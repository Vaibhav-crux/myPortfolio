...
const NavButton = ({ onClick, className, navbarCollapsed }: Props) => {
  ...
  return (
    <button
      ...
      onClick={onClick}
      aria-label={navbarCollapsed ? 'Close navigation menu' : 'Open navigation menu'} // Add this line
      title={navbarCollapsed ? 'Close navigation menu' : 'Open navigation menu'} // Add this line
    >
      <div
